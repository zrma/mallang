...
use names::{c_condition, c_ident, c_param_decl, TypeCName};
use types::{collect_defined_types, emit_drop_helpers, emit_type_definitions};

use crate::{
    ast::{BinaryOp, ParamMode, Program},
    ir::{lower, IrExpr, IrForPost, IrFunction, IrProgram},
    semantic::check,
};
...
mod tests {
    ...
    use crate::{
        ...
        check,
        ir::{
            lower, IrExpr, IrExprKind, IrForInit, IrFunction, IrProgram, IrStmt, IrStmtKind,
            IrStruct, IrStructField,
        },
        parse,
        semantic::Type,
    };
