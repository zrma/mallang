...
use names::{
    ...
    c_string, empty_slice_value_code, COperator, IrAdtConstructorCName, TypeCName,
};
...
use crate::{
    ...
    ir::{
        lower, IrAdtConstructor, IrArg, IrExpr, IrExprKind, IrForPost, IrFunction, IrMatchArm,
        IrMatchPattern, IrProgram,
    },
    semantic::{check, Type},
};
...
mod tests {
    ...
    use crate::{
        check,
        ir::{lower, IrForInit, IrStmt, IrStmtKind, IrStruct, IrStructField},
        parse,
    };
