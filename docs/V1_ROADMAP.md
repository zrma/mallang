...
- `errors.Kind`/`errors.Error` native value와 `std/strings` UTF-8
...
상태: complete; v0.9.0 freeze와 v1.0.0-rc.1 rehearsal 완료 (2026-07-17)
...
상태: released as v1.0.0 (2026-07-17)
