...
| `docs/STANDARD_LIBRARY.md` | 여섯 baseline package의 exact signature와 ownership/failure semantics가 별도 reference에 있었다. | `V1-STD-*` rule에서 reference 전체를 normative detail owner로 고정했다. |
