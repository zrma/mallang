...
- 아직 없음: struct cleanup for slice fields, first-class borrowed references, statement-spanning borrow lifetimes, full C backend, method values/interfaces/dynamic dispatch
...
1. struct cleanup for slice fields 구현 여부 결정
