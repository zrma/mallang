...
repository source와 100개 semantic fixture, 6개 IR fixture를
...
persistent outer move도 검사한다. direct local method의 owned move, `con` read,
`mut` mutability와 receiver/argument borrow overlap도 검사하며 74개 Mallang
compiler project test가 이를 고정한다. 다음 slice는 field/index/temporary method
receiver semantics다. public language
