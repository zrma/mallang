...
1. full C backend gap review 전에 남은 v0 syntax decision 재점검
2. C backend feature-completeness gap review
3. C backend generated C memory/lifetime audit
