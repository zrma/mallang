...
repository source와 80개 semantic fixture, 6개 IR fixture를
...
loop-scoped init, optional condition과 direct/field/index post도 검사한다. 다음
slice는 range loop binding과 ownership state join이다. public language
