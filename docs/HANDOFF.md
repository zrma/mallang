...
repository source와 152개 semantic fixture, 6개 IR fixture를
...
left-to-right move 순서로 검사하며 전체 125개 project test가 이를 고정한다. 다음
slice는 P176d1b2c match expected-type propagation이다. public language 또는
