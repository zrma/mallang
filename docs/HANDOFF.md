...
2. `else if` sugar와 return-completeness analysis 적용 시점 결정
3. statement-block `match` arms 필요 시점 결정
4. by-reference native ABI로 `mut` parameter mutation을 caller-visible하게 만들지 결정
