...
fixture와 전체 210개 Mallang project test가 이를 고정한다. 다음 slice는
self-consuming aggregate cleanup overwrite다. public language
또는
...
sanitizer smoke를 실행한다. 인자 없는 full gate만 전체 210개 project test와
