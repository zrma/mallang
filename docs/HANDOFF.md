...
- 아직 없음: slice surface syntax, borrowed indexing expressions, non-copy array element assignment, statement-spanning borrow lifetimes, full C backend, method values/interfaces/dynamic dispatch
...
2. borrowed indexing expression과 non-copy array element assignment의 ownership boundary 결정
