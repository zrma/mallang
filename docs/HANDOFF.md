...
2. full generated C warning-clean sweep if compile time remains acceptable
3. post-v0 syntax planning only after v0 local release-candidate snapshot is published
