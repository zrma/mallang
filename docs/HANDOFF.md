...
- 아직 없음: first-class borrowed references, statement-spanning borrow lifetimes, consuming append from slice fields, full C backend, method values/interfaces/dynamic dispatch
...
1. `append(bag.values, item)`의 field-consuming move/drop 순서 설계
