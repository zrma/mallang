...
- 소스 확장자: `.mlg`
- CLI: `mlg`
- 공개 릴리스: `v0.1.0`부터 stable `v1.0.0`까지; `v1.1.0` release-ready; macOS arm64/Linux x86_64 binary 포함
...
- v1.1.0 release-ready: `std/fs.forEachLine[C,S]`가 source-visible handle 없이
  ...
  검증하고, supported-platform artifact와 signed release publication을 기다린다.
...
- `docs/todo-v11-streaming-text-io/`: release-ready v1.1 additive streaming text I/O and acceptance
