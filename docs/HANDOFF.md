...
repository source와 89개 semantic fixture, 6개 IR fixture를
...
persistent outer move도 검사한다. 64개 Mallang compiler project test가 이를
고정하며, 다음 slice는 owned/`con`/`mut` method receiver semantics다. public language
