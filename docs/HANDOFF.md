...
repository source와 197개 semantic fixture, 6개 IR fixture를
...
통해 finite coverage를 검사하며 전체 170개 project test가 이를 고정한다. 다음
slice는 P176d2a function literal, capture propagation과 closure ownership이다. public
language 또는 standard-library addition은
