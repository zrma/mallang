...
fixture와 전체 218개 project test가 이를 고정한다. 다음 slice는 aggregate
literal typed IR과 cleanup coverage다. public language
또는
...
sanitizer smoke를 실행한다. 인자 없는 full gate만 전체 218개 project test와
