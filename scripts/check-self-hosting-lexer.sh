...
echo "self-hosting B2e1 closure typed IR, mutable and nested closure semantics, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
