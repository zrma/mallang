...
echo "self-hosting B2d2a3 mutable and nested closure differential, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
