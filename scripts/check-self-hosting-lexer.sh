...
echo "self-hosting B2b primitive semantic/typed IR differential, B1 frontend, determinism, ownership, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
