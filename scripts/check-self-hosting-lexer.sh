...
echo "self-hosting B2c3b2a for-clause ownership differential, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
