...
echo "self-hosting B2d1b2b user enum constructor differential, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
