...
echo "self-hosting B2e2a straight-line cleanup, closure typed IR, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
