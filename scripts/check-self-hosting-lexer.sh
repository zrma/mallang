...
echo "self-hosting B2c4b field/index/temporary method receiver differential, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
