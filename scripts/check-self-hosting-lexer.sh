...
echo "self-hosting B2d1b2c2b2 nested and recursive match differential, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
