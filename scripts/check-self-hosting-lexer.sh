...
echo "self-hosting B2c3b2b2 range ownership differential, B1 frontend, determinism, accounting, and sanitizer gate passed: parser-corpus=$parser_corpus_count"
